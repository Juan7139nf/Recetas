        ...
        <div class="flex flex-col gap-2 overflow-y-auto pb-6">
            ...
            <div x-data="{ isExpanded: false }" class="flex flex-col">
                ...
                <ul x-cloak x-collapse x-show="isExpanded" aria-labelledby="user-management-btn" id="user-management">
                    ...
                    <li class="px-1 py-0.5 first:mt-2">
                        <a href="#"
                            class="flex items-center rounded-sm gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-black/5 hover:text-neutral-900 focus:outline-hidden focus-visible:underline dark:text-neutral-300 dark:hover:bg-white/5 dark:hover:text-white">Permissions</a>
                    </li>
                    <li class="px-1 py-0.5 first:mt-2">
                        <a href="#"
                            class="flex items-center rounded-sm gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-black/5 hover:text-neutral-900 focus:outline-hidden focus-visible:underline dark:text-neutral-300 dark:hover:bg-white/5 dark:hover:text-white">Activity
                            Log</a>
                    </li>
                </ul>
            </div>
            ...
            <div x-data="{ isExpanded: true }" class="flex flex-col">
                ...
                <ul x-cloak x-collapse x-show="isExpanded" aria-labelledby="products-btn" id="products">
                    ...
                    <li class="px-1 py-0.5 first:mt-2">
                        <a href="#"
                            class="flex items-center rounded-sm gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-black/5 hover:text-neutral-900 focus:outline-hidden focus-visible:underline dark:text-neutral-300 dark:hover:bg-white/5 dark:hover:text-white">Reviews</a>
                    </li>
                </ul>
            </div>
            ...
            <div x-data="{ isExpanded: false }" class="flex flex-col">
                ...
                <ul x-cloak x-collapse x-show="isExpanded" aria-labelledby="orders-btn" id="orders">
                    <li class="px-1 py-0.5 first:mt-2">
                        <a href="#"
                            class="flex items-center rounded-sm gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 hover:bg-black/5 hover:text-neutral-900 focus:outline-hidden focus-visible:underline dark:text-neutral-300 dark:hover:bg-white/5 dark:hover:text-white">
                            <span>Pending</span>
