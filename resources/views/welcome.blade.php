...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data="{ dark: localStorage.getItem('theme') === 'dark' }"
    :data-theme="dark ? 'dark' : 'light'" x-init="$watch('dark', val => localStorage.setItem('theme', val))"
    class="transition-colors duration-300" data-theme="dark">
            ...
            <div
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <button @click="dark = !dark" class="bg-gray-200 dark:bg-gray-700 p-2 rounded">
                            Cambiar Tema
                        </button>
                    ...
                    <main class="mt-6">
                        ...
                        <div class="p-4 bg-gray-100 dark:bg-gray-800 rounded">
                            ¡Hola! Este bloque cambia con el modo oscuro.
                        </div>
