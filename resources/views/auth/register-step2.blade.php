<form wire:submit.prevent="completeProfile" enctype="multipart/form-data">
    ...
    <div
        ...
        <button type="submit" wire:loading.attr="disabled" wire:target="completeProfile"
            ...
            <span class="mr-2">{{__('generic.save')}}
                <svg wire:loading wire:target="completeProfile" class="inline w-4 h-4 animate-spin text-white"
